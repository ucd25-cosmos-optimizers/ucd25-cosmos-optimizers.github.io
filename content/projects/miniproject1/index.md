...
<iframe src="/plotly/miniproject1.html" width="100%" height="400px" style="border:none;"></iframe>
...
![Scatterplot of Median AQI vs. Average Income per County](/aqi_income_regression.png "The relationship between **median AQI** and **average income** for each United States county, with the regression line overlaid.")
